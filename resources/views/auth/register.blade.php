    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
              ...
              <x-jet-input id="surname" class="block mt-2 w-full" type="text" name="surname" :value="old('surname')" required autofocus autocomplete="surname" />
          </div>
            ...
            <div class="mt-4">
              ...
              <x-jet-input id="phone" class="block mt-2 w-full" type="text" name="phone" :value="old('phone')" required autofocus autocomplete="phone" />
          </div>
